...
class SimDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        ee_target = [float(item) for item in self.df['ee_taget'][index].split(",")]
...
trainSet = SimDataset("../../Demos/Dataset/try_2/data.csv",transform)
...
model = BaselineCNN() #same sizing for both ResNet34 and 50 depending on the type of residual layer used
