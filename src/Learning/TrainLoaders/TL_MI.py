...
from ..utils.utils_dataloader import get_numEpisodeRun
...
class TL_motionImage(Dataset):
    ...
    def __getitem__(self, index):
        ...
        motion_image = get_motionImage(image, future_image)
    ...
    def check_sameDemo(self, current_filename: str, future_filename: str) -> bool:
        ...
        # print(f"current: {current_demo}")
        # print(f"future: {get_numEpisodeRun(future_filename)}")
        # print(f"compared: {True if get_numEpisodeRun(future_filename) == current_demo else False}\n")
