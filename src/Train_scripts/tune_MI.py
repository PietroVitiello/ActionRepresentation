...
saved_model_name = "spacer_MItune_cube_2"
...
lr = 0.00008
lr_id = "8e5"
tags = ["MI_tuning", f"{n_demos}d, {lr_id}"]

################################################# Model

saved_model_name = f"MI_Net_cube_{n_demos}d_{lr_id}_1e7"
...
optimiser = 'Adamax'                    ###0.001 #0.0007 #0.001
weight_decay = 1e-7
...
################################################# Model
saved_model_name = f"MI_Net_cube_{n_demos}d_tune"
model_name = "MotionImage_attention"
training_method = 'AE_wandb'
...
################################################# Model
saved_model_name = f"MI_Net_cube_{n_demos}d_7e4_2e7"
weight_decay = 2e-7
...
################################################# Model
saved_model_name = f"MI_Net_cube_{n_demos}d_7e4_5e7"
weight_decay = 5e-7
...
################################################# Model
saved_model_name = f"MI_Net_cube_{n_demos}d_7e4_2e6"
weight_decay = 2e-6
...
################################################# Model
saved_model_name = f"MI_Net_cube_{n_demos}d_{lr_id}_2e7"
weight_decay = 2e-7
...
################################################# Model
saved_model_name = f"MI_Net_cube_{n_demos}d_{lr_id}_5e7"
weight_decay = 5e-7
...
################################################# Model
saved_model_name = f"MI_Net_cube_{n_demos}d_{lr_id}_2e6"
weight_decay = 2e-6
...
################################################# Model
saved_model_name = f"MI_Net_cube_{n_demos}d"
model_name = "MotionImage_attention"
training_method = 'AE_wandb'
