...
parser.add_argument('-nd', '--number_distractors', metavar="", type=int,
                    default=False,
...
n_distractors = parsed_args.number_distractors
task = parsed_args.task


scene_type = "distractor"
saved_locations = f"distr_{n_distractors}_envs" #"LinearGrasp"
